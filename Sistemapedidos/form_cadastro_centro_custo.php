      ...
      <div class="row">
        ...
        <main role="main" class="col-md-5 ml-sm-auto col-lg-10 px-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
             <h2 style="font-family:Helvetica;font-size:170%;" >Cadastro de centro de custo</h2>
          </div>
		   <?php
		  ...
		  ?>
		  <form name="form_cadastro_usuario" id="cadastro_usuario" action="cadastro_centro_custo.php" method="POST">
		  <div class="shadow p-3 mb-3 bg-white rounded">
			<div class="form-row">
				<div class="col">
					<label>Nome do Centro de Custo:</label>
					<input type="text" name="centro_custo" id="centro_custo" class="form-control" placeholder="Digite o nome da obra " required>
				</div>
			</div>
			<br>
			<div class="form-row">
				<div class="col">
				<label>Selecione um responsável para esse centro de custo :</label>
				<select class="chosen" name='colaborador'id="colaborador" required >
				<option value=''>Selecione o colaborador</option>
				<?php
				$sql="SELECT chapa,nome FROM usuarios";
					$resultado=mysqli_query($conn,$sql);
					
						while($linhas=mysqli_fetch_array($resultado)){
							?>
						<option value='<?=$linhas['chapa']?>'><?=$linhas['nome']?> </option>
						<?php
						}
				?>	
				</select>
			...
			<a href="form_centro_custo.php" class="btn btn-primary">Voltar</a>
