        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
				...
				<main role="main" class="col-md-5 ml-sm-auto col-lg-10 px-4">
					  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
						  <h2 style="font-family:Helvetica;font-size:170%;" >Centro de Custo</h2>
					  </div>
					  <?php
					  ...
					  $sql_localidade = "SELECT id_custo,nome_custo,chefe_custo,chapa_chefe FROM centro_custo ";
					$resultado1 = mysqli_query($conn,$sql_localidade);
						$numRegistros = mysqli_num_rows($resultado1);
					   if($numRegistros!=0){
					  ?>
				  <div>
				  <a href="form_cadastro_centro_custo.php" class="btn btn-primary btn-sm" role="button" aria-pressed="true" data-toggle="tooltip" data-placement="bottom" title="Cadastre uma localidade">Cadastro</a>
				  <br>
				  <br>
					  <table id="minhaTabela" class="table table-striped table-responsive-md" >
							<thead>
							  <tr>
									...
									<th style="text-align: center;">Nome Centro Custo</th>
									<th style="text-align: center;">Chefe</th>
								...
								<tbody>
										<?php
										  while($linhas=mysqli_fetch_array($resultado1)){
											  ...
											  ?>
										  <tr>
												<td style="text-align: center;"><?=$linhas['id_custo']?></td>
												<td style="text-align: center;"><?=$linhas['nome_custo']?></td>
												<td style="text-align: center;"><?=$linhas['chefe_custo']?></td>
												<td style="text-align: center;"><?=$linhas['chapa_chefe']?></td>
