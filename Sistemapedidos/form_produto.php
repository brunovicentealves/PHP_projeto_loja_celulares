        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
				...
				<main role="main" class="col-md-5 ml-sm-auto col-lg-10 px-4">
					  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
						 <h2 style="font-family:Helvetica;font-size:170%;" >Produtos</h2>
					  </div>
					  <?php
					  ...
					  $sql_localidade = "SELECT id_produto,nome_produto,valor_produto FROM produtos ";
					$resultado1 = mysqli_query($conn,$sql_localidade);
						$numRegistros = mysqli_num_rows($resultado1);
					   if($numRegistros!=0){
					  ?>
				  <div>
				  <a href="form_cadastro_produto.php" class="btn btn-primary btn-sm" role="button" aria-pressed="true" data-toggle="tooltip" data-placement="bottom" title="Cadastre uma localidade">Cadastro</a>
				  <br>
				  <br>
								...
								<tbody>
										<?php
										  while($linhas=mysqli_fetch_array($resultado1)){
											  ?>
										  <tr>
												<td style="text-align: center;"><?=$linhas['id_produto']?></td>
												<td style="text-align: center;"><?=$linhas['nome_produto']?></td>
												<td style="text-align: center;"><?=$linhas['valor_produto']?></td>
												...
												<?php  echo"<a  title=\"Excluir item\" href='delete_tabelas.php?id=".$linhas['id_produto']."&acao=produtos'  onclick=\"return confirm('Tem certeza que deseja que deseja deletar esse item?');\">"; ?>
