    ...
    <div class="container-fluid">
			  <div class="row">
					...
					<main role="main" class="col-md-5 ml-sm-auto col-lg-10 px-4">
						...
						$quantidade_pg=3;
						$num_pagina=ceil($numRegistros/$quantidade_pg);
						...
						<nav aria-label="Page navigation example">
							  ...
							  if($pagina_anterior!=0){
								?>  
								<li class="page-item ">
								  <a class="page-link" href="http://celular.tbsa.com.br/catalago.php?pagina=<?php echo $pagina_anterior;?>" tabindex="-1"><<</a>
								</li>
								<?php  
							  }else{
								  ?>
							  ...
							  ?>
								...
								?>	
									<li class="page-item"><a class="page-link" href="http://celular.tbsa.com.br/catalago.php?pagina=<?php echo $i ;?>"><?php echo $i;?></a></li>
								<?php	
								}
								if($pagina_posterior<=$num_pagina){
								?>	
								<li class="page-item">
								  <a class="page-link" href="http://celular.tbsa.com.br/catalago.php?pagina=<?php echo$pagina_posterior;?>">>></a>
								</li>
